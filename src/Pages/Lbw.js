...
const formFields = {
    ...
    omaps: { label: "Mother's Mental Health Status" },
    famps: { label: "Father's Mental Health Status" },
    ...
    mwhte: { label: "Mother's White Ethnicity" },
    mblck: { label: "Mother's Black Ethnicity" },
    moth: { label: "Mother's Health Status" },
    fwhte: { label: "Father's White Ethnicity" },
    fblck: { label: "Father's Black Ethnicity" },
    forth: { label: "Other Factors" },
};
